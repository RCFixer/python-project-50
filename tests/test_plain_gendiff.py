...
@pytest.fixture
def expected_result():
    return ["Property 'common.follow' was added with value: false", "Property 'common.setting2' was removed",
            ...
            "Property 'group2' was removed", "Property 'group3' was added with value: [complex value]"]
